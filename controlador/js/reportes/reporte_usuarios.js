...
new Vue({
  ...
  data: {
    ...
    data:[],
    headings: [
      {text: 'No.', align: 'left', sortable: true, value: 'orden'},
  ...
  methods: {
    ...
    fnCargarFuncionesAsistencia(){
      ...
      if(this.headings.length == 9 && this.fecha != 0)
      {
        this.headings.shift();
        this.headings.unshift({text: 'Asistencia', value: 'asistencia', align: "center"});
        this.headings.unshift({text: 'No.', align: 'left', sortable: true, value: 'orden'});
      }
    },
