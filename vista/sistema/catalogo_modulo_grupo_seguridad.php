 ...
 */
?>
<div id="app2" data-script="../../controlador/js/sistema/catalogo_modulo_grupo_seguridad.js">
    <v-app>
        <v-container fluid>
            <v-card raised>
                <v-toolbar dark color="primary">
                    <h2>Asignar sub módulo a perfil</h2>
                </v-toolbar>
                <v-card flat>
                    <v-card-actions>
                        <v-container>
                            <v-row>
                                <v-col>
                                    ...
                                    item-text="nombre"
                                    :loading="loading" @change="combo_menu= [], fnMenu(),fnListaTabla()" >
                                    </v-select>
                                </v-col>
                            </v-row>
                            <v-row>
                                <v-col>
                                    <v-select label="Módulo" 
                                    v-model="cve_menu" 
                                    :items="combo_menu" 
                                    item-value="cve_menu"
                                    item-text="nombre"
